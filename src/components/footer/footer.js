      ...
      <div className="max-w-content mx-auto px-4 sm:px-6 py-6">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <img src={logoValor} alt="Valor Econômico" className="h-5 md:h-6 w-auto" loading="lazy" />
          </div>
        ...
        <p className="text-center text-xs text-gray-500 mt-4">
          Conteúdo oferecido por Kia. Produzido pelo Valor Econômico para Editora Globo.
        </p>
      </div>
    </footer>
  );

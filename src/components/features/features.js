...
function Features() {
  return (
    <section aria-labelledby="features-heading" className="bg-gray-50 py-14 md:py-20">
      <div className="max-w-content mx-auto px-4 sm:px-6">
        <h2 id="features-heading" className="text-2xl md:text-3xl font-bold text-center text-sorento-graphite mb-2">
